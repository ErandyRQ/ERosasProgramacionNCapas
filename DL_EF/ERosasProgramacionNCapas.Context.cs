...
namespace DL_EF
{
    ...
    public partial class ERosasProgramacionNCapasEntities1 : DbContext
    {
        public ERosasProgramacionNCapasEntities1()
            : base("name=ERosasProgramacionNCapasEntities1")
        {
        }
        ...
        public virtual int UsuarioAdd(string nombre, string apellidoPaterno, string apellidoMaterno, string fechaNacimiento, string telefono, string username, string email, string password, string sexo, string celular, string cURP, Nullable<int> idRol, string calle, string numeroInterior, string numeroExterior, Nullable<int> idColonia)
        {
        ...
        public virtual int UsuarioUpdate(Nullable<int> idUsuario, string nombre, string apellidoPaterno, string apellidoMaterno, string fechaNacimiento, string telefono, string username, string email, string password, string sexo, string celular, string cURP, Nullable<int> idRol, string calle, string numeroInterior, string numeroExterior, Nullable<int> idColonia)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(int));
